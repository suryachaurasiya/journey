...
import healthProduct.ReadExcel;
...
public class CignaProposal {
	...
	// Declare An Excel Work Book
		...
		try {
			...
			WebElement salutation = driver.findElement(uimap.getLocator("Salutation_text"));
			salutation.click();
	...
	@Test(description = "Fill Child Salutation", priority = 16)
	...
	@Test(description = "Fill Child First Name", priority = 17)
	...
	@Test(description = "Fill Child Last Name", priority = 18)
	...
	@Test(description = "Fill Child DOB", priority = 19)
	...
	public void MedicalHistory() throws Exception {
		...
		try {
			...
			questionone.click();
			Thread.sleep(1000);
			WebElement questiontwo = driver.findElement(uimap.getLocator("MedicalHistory_question_one_no"));
			questiontwo.click();
			Thread.sleep(1000);
			WebElement questionthree = driver.findElement(uimap.getLocator("MedicalHistory_question_one_no"));
			questionthree.click();
			Thread.sleep(1000);
	...
	public void MedicalHistorySaveAndContinue() throws Exception {
		...
		try {
			...
			WebElement MedicalHistorySaveandContinue = driver.findElement(uimap.getLocator("MemberDetail_SaveandContinue_button"));
	...
	public void ProceedToPayment() throws Exception {
		...
		try {
			...
			Thread.sleep(1000);
			TestNGResults.put("29", new Object[] { 29d, "Click on Proceed to proceed to payment", "Proposal page should be redirect on payment gateway", "Pass" });
			...
			test.log(Status.ERROR, e.getMessage());
			TestNGResults.put("29", new Object[] { 29d, "Click on Proceed to proceed to payment", "Proposal page should be redirect on payment gateway", "Fail" });
			//Assert.assertTrue(false);
		}
	}
